...
public class Rotate3dAnimation2 extends Animation {
    ...
    public static AnimationPair getFlipAnimations(Rotate rotate, int duration) {
        return new AnimationPair(
                new Rotate3dAnimation2(rotate, Angle.FROM_DEGREES_0, duration, true),
                new Rotate3dAnimation2(rotate, Angle.TO_DEGREES_0, duration, false));
    }
    private Rotate3dAnimation2(Rotate rotate, Angle angle, int duration, boolean accelerate) {
        this.rotate = rotate;
        this.angle = angle;
